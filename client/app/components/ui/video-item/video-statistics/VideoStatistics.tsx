...
const VideoStatistics:FC<IVideoStat> = ({createdAt,views,likes, subscribers}) => {
    return (
        <div className={cn(styles.number_info, 'profileStat')}>
            ...
            {!!subscribers && <div className={styles.subscribers}>SUBSCRIBERS {nFormatter(subscribers)}</div>}
        </div>
    );
};
