        ...
        <div className="weekly_featured">
            <div className="info_wf">
                ...
                <div className="description">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam harum placeat
                    ullam vel non, quisquam totam, doloremque expedita odit consectetur minima vitae.
                    Facilis nostrum cumque illum fugit rem, nam consectetur!
                </div>
            ...
            <div className="top_video">
                <div className="video_item">
                    ...
                    <div className="description">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus animi aut vel
                        alias voluptate, odio. Tempora sequi et itaque enim a, aut excepturi adipisci
                        quam, aspernatur, eaque obcaecati dolor tenetur :)
                    </div>
